...
rsync -avzP -e 'ssh -o "ProxyCommand ssh amnonam@sheshet.cslab.openu.ac.il -W %h:%p"' SraRunTable.txt amnonam@my.hpc.pub.lan:work/$1/
# copy to sheshet
...
ssh amnonam@sheshet.cslab.openu.ac.il "ssh my.hpc.pub.lan \"cd work/$1 ; /home/amnonam/scripts/doit2.sh --job-name=$1 --mail-type=end --mail-user=amnonim@gmail.com\""
